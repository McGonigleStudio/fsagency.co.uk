const basePath = '/var/www/html/fsagency.co.uk';
...
module.exports = async () => {
    ...
    mix.listen('init', function (mix) {
        ...
        mix._api.alias({
            '$': '/var/www/html/fsagency.co.uk/plugins',
            '~': '/var/www/html/fsagency.co.uk',
        });
    ...
    require('/var/www/html/fsagency.co.uk/themes/fsagency/winter.mix.js');
